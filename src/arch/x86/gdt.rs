...
use x86::segmentation::{
    BuildDescriptor, Descriptor as Descriptor32, DescriptorBuilder,
    GateDescriptorBuilder, SegmentDescriptorBuilder, SegmentSelector, load_cs,
    load_ds, load_es, load_fs, load_gs, load_ss,
};
    ...
    unsafe {
        ...
        BSP_GDT.tss =
            <DescriptorBuilder as GateDescriptorBuilder<UsizeT>>::tss_descriptor(
                PAddr::from_lowmem_vaddr(VAddr(&BSP_TSS as *const _ as _))
                    .unwrap()
                    .0 as _,
